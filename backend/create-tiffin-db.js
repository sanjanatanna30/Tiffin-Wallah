...
// Create Tiffin database and add a user
const createTiffinDB = async () => {
  try {
    ...
    const userData = {
      fullName: 'Admin User',
      email: 'admin@tiffinwallah.com',
      password: 'admin123',
      phone: '1234567890',
      address: '123 Tiffin Street, Food City',
      role: 'admin'
    };
    ...
    console.log('Collections in Tiffin database:', collections.map(c => c.name));
    ...
    console.error('Error creating Tiffin database:', error.message);
